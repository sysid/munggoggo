...
from behaviour import EmptyBehav, Behaviour
from core import Core
from handler import Control, RmqMessageTypes
from messages import Ping, Pong, RpcError, DemoObj, ListBehav, ManageBehav, ListTraceStore, Shutdown, ControlMessage, \
    PingControl
...
class TestRpcHandler:
    ...
    async def test_list_trace_store(self, core1, mocker):
        ...
        assert result.traces[0][2] == 'incoming'
